...
public class Constants {
	...
	public final static String SERVER_MAXCONN="server_maxconn";
	public final static String SERVER_WIDTH="server_width";
	public final static String SERVER_HEIGHT="server_height";
}
